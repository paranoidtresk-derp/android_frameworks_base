...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener {
            ...
            if (Intent.ACTION_TIME_TICK.equals(action)
                ...
                final Message msg = mHandler.obtainMessage(
                        MSG_BATTERY_UPDATE, new BatteryStatus(status, level, plugged, health,
                                maxChargingMicroWatt, dashChargeStatus, maxChargingMicroAmp,
                                maxChargingMicroVolt, temperature));
                mHandler.sendMessage(msg);
    ...
    protected KeyguardUpdateMonitor(Context context) {
        ...
        mBatteryStatus = new BatteryStatus(BATTERY_STATUS_UNKNOWN, 100, 0, 0, 0, false, 0 ,0, 0);
